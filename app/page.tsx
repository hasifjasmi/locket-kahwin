          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            >
              ...
              <input
                ...
                disabled={uploading}
              />
              {/* Library input - opens photo picker/gallery on mobile */}
              <input
                ref={libraryInputRef}
                type="file"
                accept="image/*"
                ...
                <div className="space-y-3 sm:space-y-4 py-2">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-5 py-3 bg-amber-500 hover:bg-amber-600 text-white rounded-xl transition-all text-sm font-medium min-h-[44px]"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-5 py-3 bg-white dark:bg-gray-700 border-2 border-amber-500 text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-gray-600 rounded-xl transition-all text-sm font-medium min-h-[44px]"
                    >
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
